...
void setup()
{
  ...
  server.on("/report", HTTP_GET, [](AsyncWebServerRequest *request) {
    ...
    for (int i = 0; i < paramsNr; i++)
    {
      ...
      String formData = "{\"payload\":\"" + webData + ",\"location\": {\"lat\": 121.00" + random(14000, 18736) + ", \"lng\": 14.50" + random(1865, 95063) + "}}";
...
{
  return "{\"details\":\"" + msg + "\",\"device_id\":\"" + UID + "\",\"type\":\"" + type + "\",\"title\":\"" + title + "\",\"name\":\"" + title + "\",\"reportee\":\"N/A\",\"source_platform\":\"node\",\"coordinates\":{\"long\":121.00" + random(14000, 18736) + ",\"lat\":14.50" + random(1865, 95063) + "}}";
}
