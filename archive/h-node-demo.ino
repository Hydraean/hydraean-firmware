...
void setup()
{
  ...
  server.on("/report", HTTP_GET, [](AsyncWebServerRequest *request) {
    ...
    for (int i = 0; i < paramsNr; i++)
    {
      ...
      String formData = "{\"payload\":\""+webData+",\"location\": {\"lat\": 121.001433, \"lng\": 14.507936}}";
...
String report(String type, String msg, String title){
  return "{\"details\":\""+msg+"\",\"device_id\":\""+UID+"\",\"type\":\""+type+"\",\"title\":\""+title+"\",\"name\":\""+title+"\",\"reportee\":\"N/A\",\"source_platform\":\"node\",\"coordinates\":{\"long\":121.001433,\"lat\":14.507936}}";
}
